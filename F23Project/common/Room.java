package F23Project.common;

import java.util.ArrayList;
import java.util.Iterator;
import java.util.List;

import F23Project.server.*;
import F23Project.common.*;
...
public class Room {
		...
		if (clients.indexOf(client) > -1) {
			...
			new Thread() {
				...
				public void run() {
					...
					sendMessage(client, "joined the room " + self.getName());
				}
			}.start();
	 ...
	 */
	public synchronized void sendMessage(ServerThread sender, String message) {
		if(!isRunning){
			return;
		}
